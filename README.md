...
OOP
 By: Guillaume
 Weight: 5
 Project to be done in teams of 2 people (your team: Olalekan Otaoroju, ThatAgricBoy Samuel)
 Ongoing second chance project - started May 8, 2023 6:00 AM, must end by May 17, 2023 6:00 AM
 Manual QA review must be done (request it when you are done with the project)
 An auto review will be launched at the deadline
In a nutshell…
Contribution: 100.0%
Manual QA review: In second deadline
Auto QA review: 198.0/302 mandatory & 59.0/233 optional
...
2. Unittests
mandatory
Score: 46.15% (Checks completed: 46.15%)
...
8. First User
mandatory
Score: 56.76% (Checks completed: 56.76%)
...
13. Show
#advanced
Score: 21.43% (Checks completed: 21.43%)
